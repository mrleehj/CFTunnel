...
- 网络访问：http://服务器IP:3000（使用日志中显示的 IP 地址）

**重要**: 请立即登录并修改默认密码！详见 [SECURITY.md](./SECURITY.md)
...
```bash
cftm version         # 显示版本信息
cftm check-update    # 检查更新
cftm update          # 自动更新到最新版本
```
